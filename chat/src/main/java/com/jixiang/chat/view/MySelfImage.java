...
public class MySelfImage extends ImageView {
	public MySelfImage(Context context) {
		super(context);
	}

	public MySelfImage(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MySelfImage(Context context, AttributeSet attrs, int defStyle) {
