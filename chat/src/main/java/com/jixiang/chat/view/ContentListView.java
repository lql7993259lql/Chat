...
//	private RotateAnimation reverseAnimation;
	...
	private void init(Context context) {
		setCacheColorHint(context.getResources().getColor(R.color.chat_transparent));
		inflater = LayoutInflater.from(context);
		
		fl = (FrameLayout)inflater.inflate(R.layout.chat_dropdown_lv_head, null);
